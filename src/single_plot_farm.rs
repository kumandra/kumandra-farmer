...
use std::sync::Arc;
use kumandra_core_primitives::{PieceIndexHash, PublicKey};
use kumandra_networking::libp2p::identity::sr25519;
use kumandra_networking::libp2p::multiaddr::Protocol;
use kumandra_networking::libp2p::{Multiaddr, PeerId};
use kumandra_networking::multimess::MultihashCode;
use kumandra_networking::{
...
impl SinglePlotFarm {
        ...
        NewPlot: Fn(usize, PublicKey, u64) -> Result<Plot, PlotError> + Clone + Send + 'static,
    {
        ...
        let codec = KumandraCodec::new_with_gpu(&plot.public_key());
        let create_networking_fut = kumandra_networking::create(Config {
            bootstrap_nodes,
